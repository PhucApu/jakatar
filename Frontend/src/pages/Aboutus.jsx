...
//       {/* Phuong Trang Section */}

{
  /* <div className="text-center py-16 px-8 bg-white shadow-lg rounded-lg mx-auto max-w-5xl">
  <div className="">
    <h1 className="text-4xl uppercase font-bold text-teal-600">ANHBA BUS</h1>
    <p className="text-lg font-bold text-grey-500 mt-2">
      “Chất lượng là danh dự”
    </p>
    <p className="mt-6 text-gray-800 leading-relaxed max-w-3xl mx-auto">
      Tập đoàn AnhBa Bus được thành lập năm 2001. Với hoạt động kinh doanh chính
      trong lĩnh vực mua bán xe ô tô, vận tải hành khách, bất động sản và kinh
      doanh dịch vụ...
      <br /> <br />
      Trải qua hơn 20 năm hình thành và phát triển, đặt khách hàng là trọng tâm,
      chúng tôi tự hào trở thành doanh nghiệp vận tải nòng cốt đóng góp tích cực
      vào sự phát triển chung của ngành...
    </p>
  </div>
  <div className="">
    <img src="/About_Us/tam-nhin-va-su-menh.png" alt="" className="" />
  </div>
</div>; */
}
...
//             TẦM NHÌN VÀ SỨ MỆNH
//           </h2>
//           <p className="text-center text-grey-500 mt-4 text-lg font-bold">
//             Bảo Đảm Tổ Quốc Vì Một Việt Nam Hùng Cường
//           </p>
//           <ul className="mt-8 max-w-3xl mx-auto list-disc list-inside text-gray-800">
//             <li className="py-2">
...
//           </ul>
//           <p className="text-center mt-8 text-gray-800 max-w-3xl mx-auto">
//             AnhBa Bus luôn phấn đấu làm việc hiệu quả nhất, để luôn cống hiến,
//             đóng góp hết sức mình vì một Việt Nam hùng cường.
//           </p>
//         </div>
//         <div className="">
//           <img src="/About_Us/gia-tri-cot-loi.png" alt="" className="" />
//         </div>
//       </div>

//       {/* Gia Tri Cot Loi Section */}
//       <div className="py-16 px-8 bg-white shadow-lg rounded-lg mx-auto max-w-5xl mt-12">
//         <div className="">
...
//           </p>
//           <p className="mt-8 max-w-3xl mx-auto text-gray-800 leading-relaxed">
...
//         </div>
//         <div className="">
//           <img src="/About_Us/triet-ly.png" alt="" className="" />
//         </div>
//       </div>
//     </section>
//   );
...
export default function AboutUs() {
  return (
    <section className="bg-gray-100 text-gray-900 min-h-screen">
      {/* Phuong Trang Section */}
      {/* <div className="py-16 px-8 bg-white shadow-lg rounded-lg mx-auto max-w-6xl flex flex-col md:flex-row items-center">
        <div className="md:w-1/2">
          ...
          <p className="mt-6 text-gray-800 leading-relaxed">
            Tập đoàn AnhBa Bus – FUTA Group được thành lập năm 2001. Với hoạt
            động kinh doanh chính trong lĩnh vực mua bán xe ô tô, vận tải hành
            khách, bất động sản và kinh doanh dịch vụ...
            <br /> <br />
            Trải qua hơn 20 năm hình thành và phát triển, đặt khách hàng là
            trọng tâm, chúng tôi tự hào trở thành doanh nghiệp vận tải nòng cốt
            đóng góp tích cực vào sự phát triển chung của ngành...
          </p>
        </div>
